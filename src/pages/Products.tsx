  ...
  return (
    <div className="md:mx-20 xl:mx-10 2xl:mx-20 mt-28">
      <div className="text-2xl font-bold">
        <div className="flex w-full sm:min-w-[70%] lg:min-w-[60%] xl:min-w-[50%] 2xl:min-w-[40%] justify-center max-w-sm mx-auto items-center space-x-2">
          <Input className="border" type="search" placeholder="Search" />
          ...
          <Select>
            ...
            <SelectContent>
              <SelectGroup>
                ...
                <SelectItem value="low to highh">Low to high</SelectItem>
